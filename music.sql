...
CREATE TABLE albums (album_id serial primary key, album_name varchar(100) not null, artist_id imteger not null references artists(artist_id), year integer);

CREATE TABLE tracks (id_track serial primary key, album_id integer not null references albums(album_id), track_name varchar(100), track_length varchar(40));